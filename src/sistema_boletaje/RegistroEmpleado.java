...
public class RegistroEmpleado extends javax.swing.JInternalFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(btmRegistrar, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(53, 53, 53)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                ...
                if(!"".equals(txtnumerolicencia.getText())||cbxcargo.getSelectedIndex()!=1){
                    if(!"".equals(txtfecha1.getText())||cbxcargo.getSelectedIndex()!=1){
                        if(cbxcargo.getSelectedIndex()!=0||cpropietario.isSelected()){
                            if(!PD.verificarIdentificacion(txtnidentificacion.getText())){
                                if(ComprobarEdad()){
                                    ...
                                    PD.Distribucion(ObtenerCodigo(),nombre.toUpperCase(), apellidopa.toUpperCase(), apellidoma.toUpperCase(), tidentificacion, nidentificacion, sexo, fechanaci, direccion, distrito, telefono, celular, activo, propietario, cargo, tipolicencia, nlicencia, vencimientolicencia,this.fis,this.longitudBytes);
                                ...
                                JOptionPane.showMessageDialog(null, "EL NUMERO DE DNI YA SE ENCUENTRA REGISTRADO");
                            }
    ...
    private void txtfechaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtfechaFocusLost
        ...
        if(txtfecha.getText().length()<10){
            ...
            eMesagge="Fecha Nacimiento No valida\n";
        }
